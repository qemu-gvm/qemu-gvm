...
struct GVMState
{
    ...
    HANDLE fd;
    HANDLE vmfd;
    QTAILQ_HEAD(, gvm_sw_breakpoint) gvm_sw_breakpoints;
    int intx_set_mask;
...
static void gvm_set_kernel_irqchip(Object *obj, Visitor *v,
                                   const char *name, void *opaque,
                                   Error **errp)
{
    Error *err = NULL;
    GVMState *s = GVM_STATE(obj);
    OnOffSplit mode;
...
static void gvm_accel_instance_init(Object *obj)
{
    GVMState *s = GVM_STATE(obj);
...
static void gvm_accel_class_init(ObjectClass *oc, void *data)
{
    ...
    object_class_property_add(oc, "kernel-irqchip", "on|off",
        NULL, gvm_set_kernel_irqchip,
        NULL, NULL);
    object_class_property_set_description(oc, "kernel-irqchip",
        "Configure GVM in-kernel irqchip");
}

static const TypeInfo gvm_accel_type = {
    .name = TYPE_GVM_ACCEL,
    .parent = TYPE_ACCEL,
    .instance_init = gvm_accel_instance_init,
