...
const CpusAccel gvm_cpus = {
    .create_vcpu_thread = gvm_start_vcpu_thread,
    .kick_vcpu_thread = gvm_kick_vcpu_thread,

    .synchronize_post_reset = gvm_cpu_synchronize_post_reset,
    .synchronize_post_init = gvm_cpu_synchronize_post_init,
    .synchronize_state = gvm_cpu_synchronize_state,
    .synchronize_pre_loadvm = gvm_cpu_synchronize_pre_loadvm,
};
